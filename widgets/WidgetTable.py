...
from utils.utils import copy_dict
                ...
                if issubclass(w, Label):
                    if isinstance(self.pattern[column], dict):
                        ...
                        if self.pattern[column].get('var') is not None:
                            apply = lambda wgt, var: wgt.configure(  # noqa: E731,E501
                    ...
                    if issubclass(w, Combobox):
                        ...
                        if isinstance(self.pattern[column], dict):
                            def apply(wgt, var):
                                ...
                                select_value = lambda e, w=wgt: var.set(  # noqa: E731,E501
                                    wgt.get())
                    ...
                    # We'll try and use a method called `modify`. This will be
                    # a method that people can give an object which will allow
                    # it be be updated
                    try:
                        if isinstance(self.pattern[column], dict):
                            apply = lambda wgt, var: wgt.modify(**var)  # noqa: E731,E501
                        else:
                            apply = lambda wgt, var: wgt.modify(var)  # noqa: E731,E501
